...
<?php $metaTags = 'strategy tactical vision future goals planning index'; ?>
...
<?php include('assets/include/nav.php');?>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-8 col-md-8 col-sm-12 desc"><br>
                <h1><strong>What Can Blue Do For You?</strong></h1>
                <h2 class="dots">​Shape an amazing workplace by...</h2>
            </div>
        </div>
    </div>

    <!--Green Side Navigation on Strategies Page-->
    <div id="mySidenav" class="sidenav">
        <a href="#cultureArea" id="culture">Culture</a>
        <a href="#communicationArea" id="communication">Communication</a>
        <a href="#developmentArea" id="development">Development</a>
        <a href="#complianceArea" id="compliance">Compliance</a>
    </div>

        <!--Gray line with culture icon-->
        <div class="container-fluid" id="cultureArea">
            <hr class="grayLineCulture">
        </div><br>

    <!--paragraph and picture in culture section-->
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-12">
                <img src="assets/img/strategies-culture.jpg" class="img-fluid" id="strategiesImage">
                <img src="assets/img/design-blueRectangle.png" class="img-fluid" id="blueRectangle-strategies-img-top">
                <img src="assets/img/design-greenLines.png" class="img-fluid" id="greenLines-strategies-img">
                <span class="text-justify"></span>
            </div>
            <div class="col-lg-8 col-md-8 col-sm-12 desc">
                <div class="row">
                    <div class="col-lg-9 col-md-8 col-sm-12"><br>
                        <h2>Being Intentional About Company Culture</h2>
                        <hr class="greenLine2">
                        <p class="body-text">
                            ...
                            <strong>When we are intentional about driving positive
                            culture...</strong><br>
                            ...
                            <strong>​If we ignore culture in the workplace...</strong><br>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-12">
                <img src="assets/img/strategies-communication.jpg" class="img-fluid" id="strategiesImage">
                <img src="assets/img/design-blueRectangle.png" class="img-fluid" id="blueRectangle-strategies-img-bottom">
                <img src="assets/img/design-greenLines.png" class="img-fluid" id="greenLines-strategies-img">
                <span class="text-justify"></span>
            </div>
            <div class="col-lg-8 col-md-8 col-sm-12 desc"><br>
                <div class="row">
                    <div class="col-lg-9 col-md-8 col-sm-12"><br>
                        <h2>Implementing Effective Communication</h2>
                        <hr class="greenLine2">
                        <p class="body-text">
                        ...
                        <strong>Gather candid employee feedback.</strong><br>
                        ...
                        <strong>Recognize excellence in every employee.</strong><br>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-12">
                <img src="assets/img/strategies-employeeDev.jpg" class="img-fluid" id="strategiesImage">
                <img src="assets/img/design-blueRectangle.png" class="img-fluid" id="blueRectangle-strategies-img-top">
                <img src="assets/img/design-greenLines.png" class="img-fluid" id="greenLines-strategies-img">
                <span class="text-justify"></span>
            </div>
            <div class="col-lg-8 col-md-8 col-sm-12 desc"><br>
                <div class="row">
                    <div class="col-lg-9 col-md-8 col-sm-12"><br>
                        <h2>Committing to Employee Development</h2>
                        <hr class="greenLine2">
                            <p class="body-text">
                            ...
                            <strong>Supervisor Responsibility</strong><br>
                            ...
                            greatest liability.<br><br>

                            <strong>Individualized Approach</strong><br>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-12">
                        <img src="assets/img/strategies-compliance.jpg" class="img-fluid" id="strategiesImage">
                        <img src="assets/img/design-blueRectangle.png" class="img-fluid" id="blueRectangle-strategies-img-bottom">
                        <img src="assets/img/design-greenLines.png" class="img-fluid" id="greenLines-strategies-img">
                        <span class="text-justify"></span>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-9 col-md-8 col-sm-12"><br>
                                ...
                                <hr class="greenLine2">
                                    ...
                                    <strong>An ounce of prevention...</strong><br>
                                    ...
                                    <strong>Acronyms don't have to inspire dread.</strong><br>
