...
<?php include('assets/include/nav.php');?>
    ...
    <div class="container"><hr class="dottedBlueLine"></div>
        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-md-8 col-sm-12"><br>
                <p class="body-text"><!--used to have class of borderBlue=green border around text-->
                    ...
                    clients have needs that are just a little out of
                    scope. Blue Ivy Professional Services is proud
                    to collaborate with amazing organizations in
                    order to bring a best-in-class suite of services
                    to our shared clients in several ways:
                </p>
            ...
            <div class="col-lg-8 col-md-8 col-sm-12">
                ...
                <div class="container">
                    <ul><!-- used to be class="noStyle" no bullets-->
                        ...
                        <li><strong>Employee Recognition Programs</strong></li>
                        <li><strong>Structured Team Building Activities</strong></li> 
                        <li><strong>Training and Development Plans</strong></li>
                    </ul>
                </div><br>
        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-md-8 col-sm-12"><br>
                ...
                <p class="body-text"><!--used to have class of borderBlue=green border around text-->
                    ...
                    today to discuss some of the amazing
                    partnerships that your organizations can
                    leverage to further your strategic vision.
                </p>
                <div class="greenLine3"></div><br>
                <div class="container">
                    <ul><!-- used to be class="noStyle" no bullets-->
                        ...
                        <li><strong>Executive Recruiting Firms</strong></li>
                    </ul>
                </div>
            </div>
        </div>
