            ...
            <div id="cards">
                <div class="container my-6 py-5 text-center">
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="container high100"></div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="card align-items-center">
                                        <img src="assets/img/ivyIcon.png" alt="" class="img-fluid rounded-circle w-25 mb-3 align-items-start">
                                        <div class="card-body w-100">
                                            <div class="jumbotron drk jumbotron-fluid picx pic7">
                                            </div>
                                            <h4><strong>Workplace Injury Guidelines</strong></h4>
                                            <p class="align-items-center">No manager looks forward to a workplace injury, but all employees nonetheless should report incidents immediately with no fear of retaliation. These guidelines will help get an employee treated and back to work.</p> <br>
                                            <div class="short-row"></div>
                                            <div class="card-buttons">
                                                <div class="p-4">
                                                    <a href="assets/doc/WorkplaceInjuries.pdf"  target=”_blank” class="btn btn-success">Read More</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="card align-items-center">
                                        <img src="assets/img/ivyIcon.png" alt="" class="img-fluid rounded-circle w-25 mb-3 align-items-start">
                                        <div class="card-body w-100">
                                            <div class="jumbotron drk jumbotron-fluid picx pic8">
                                            </div>
                                            <h4><strong>FTEs De-Mystified</strong></h4>
                                            <p class="align-items-center">It is common for regulatory guidelines to be based on Full Time Equivalents. This is different from employee headcount. Find out how.</p> <br>
                                            <div class="short-row"></div>
                                            <div class="card-buttons">
                                                <div class="p-4">
                                                    <a href="assets/doc/FTEsDeMystified.pdf"  target=”_blank” class="btn btn-success">Read More</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
